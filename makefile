Postdoc-proposal.pdf: Postdoc-proposal.md Postdoc-proposal.bib format.sty
	pandoc -H format.sty -V fontsize=12pt --bibliography Postdoc-proposal.bib --csl=national-science-foundation-grant-proposals.csl Postdoc-proposal.md -o Postdoc-proposal.pdf

Postdoc-proposal-dataplan.pdf: Postdoc-proposal-dataplan.md Postdoc-proposal.bib format.sty
	pandoc -H format.sty -V fontsize=12pt --bibliography Postdoc-proposal.bib --csl=national-science-foundation-grant-proposals.csl Postdoc-proposal-dataplan.md -o Postdoc-proposal-dataplan.pdf
